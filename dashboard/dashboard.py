...
if analysis_number == 1:
    st.write(
        ...
        Dilihat dari hasil visualisasi data di atas, banyaknya hari libur tidak menentukan banyaknya pengguna sepeda pada bulan tersebut.
        """
    )
    ...
    st.write(
        ...
        Dari data di atas dapat disimpulkan bahwa pengguna paling banyak didapatkan oleh pengguna yang terdaftar dengan total pengguna lebih dari 2,5jt.
        """
    )
    ...
    st.write(
        ...
        Dari data di atas menunjukkan bahwa pengguna sepeda paling banyak pada musim gugur, bisa jadi karena cuaca di musim gugur yang sejuk dengan pemandangan gugurnya daun pohon yang membuat kesan romantis.
        """
    )
